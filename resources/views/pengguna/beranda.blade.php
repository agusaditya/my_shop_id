...
@section('content')
<div class="site-blocks-cover" style="background-image: url({{ asset('user_assets/images/back.jpg') }});" data-aos="fade">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                <a class="block-2-item item1" href="{{ route('produk') }}?kategori=sepak-bola">
                    <figure class="image">
                        <img src="{{ asset('user_assets/images/bag.jpg') }}" alt="" class="img-fluid">
                    </figure>
                    <div class="text">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                <a class="block-2-item item2" href="{{ route('produk') }}?kategori=basket">
                    <figure class="image">
                        <img src="{{ asset('user_assets/images/bag1.jpg') }}" alt="" class="img-fluid">
                    </figure>
                    <div class="text">
                        <span class="text-uppercase">Lihat Koleksi</span>
                        <h3>Accesoris</h3>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                <a class="block-2-item item3" href="{{ route('produk') }}?kategori=tennis">
                    <figure class="image">
                        <img src="{{ asset('user_assets/images/shoess.jpg') }}" alt="" class="img-fluid">
                    </figure>
                    <div class="text">
                        <span class="text-uppercase">Lihat Koleksi</span>
                        <h3>Sepatu</h3>
